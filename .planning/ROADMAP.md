...
- [ ] 04-01-PLAN.md — Update-checker unit tests + restore scoped `requiredPermissions.network` in manifest.json [UPD-01, UPD-03, DIST-01]
...
| 4. Release Automation & Distribution | 0/4 | Planned | - |
